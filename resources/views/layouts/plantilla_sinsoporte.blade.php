...
<head>
    ...
    <link href="{{ asset('template/assets/css/components/tabs-accordian/custom-tabs.css') }}" rel="stylesheet"
        type="text/css" />
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('template/table-responsive/responsive.dataTables.min.css') }}">
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="header-container fixed-top">
        <header class="header navbar navbar-expand-sm expand-header d-flex justify-content-around"
            style="background: #302f30; height:5rem;">
    ...
    <!--  BEGIN MODAL  -->
    <div id="ModalRegistro" data-backdrop="static" data-keyboard="false"
        class="modal animated fadeInUp custo-fadeInUp bd-example-modal-lg scrollpagina" tabindex="-1" role="dialog"
    ...
    <div id="ModalRegistroGrande" data-backdrop="static" data-keyboard="false"
        class="modal animated fadeInUp custo-fadeInUp bd-example-modal-xl" tabindex="-1" role="dialog"
        aria-labelledby="ModalRegistroGrande" aria-hidden="true">
    ...
    <div id="ModalUpdate" data-backdrop="static" data-keyboard="false"
        class="modal animated fadeInRight custo-fadeInRight bd-example-modal-lg scrollpagina" tabindex="-1"
    ...
    <div id="ModalUpdateGrande" data-backdrop="static" data-keyboard="false"
        class="modal animated fadeInUp custo-fadeInUp bd-example-modal-xl" tabindex="-1" role="dialog"
        aria-labelledby="ModalUpdateGrande" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
            </div>
        </div>
    ...
    <div id="ModalUpdateSlide" data-backdrop="static" data-keyboard="false"
        class="modal animated fadeInRight custo-fadeInRight bd-example-modal-xl" tabindex="-1" role="dialog"
        aria-labelledby="ModalUpdateSlide" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
    ...
    <div id="Modal_IMG_Link" class="modal animated zoomInUp custo-zoomInUp bd-example-modal-xl"
        data-backdrop="static" data-keyboard="false" role="dialog" tabindex="-1" role="dialog"
    ...
    <div id="Modal_IMG" class="modal animated zoomInUp custo-zoomInUp bd-example-modal-xl" data-backdrop="static"
        data-keyboard="false" role="dialog" tabindex="-1" role="dialog" aria-labelledby="ModalUpdate"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (id_tipo == "44") {
                        ...
                        window.open("{{ route('linea_carrera.evaluacion', ':id') }}".replace(':id', resp),
                            "_blank");
                    } else if (id_tipo == "47") {
                        window.location = "{{ route('linea_carrera') }}";
                    } else if (id_tipo == "6") {
                ...
                if (imagen != "") {
                    if (imagen2 == "PDF" || imagen2 == "pdf") {
                        document.getElementById("archivo").innerHTML =
                            "<iframe height='350px' width='100%' src='" + nombre_archivo +
                        ...
                        document.getElementById("archivo").innerHTML =
                            "<video id='video-player'  preload='metadata'playsinline  controls controlslist='nodownload' class='card-img-top img-portal' alt='widget-card-2'><source src='" +
                            nombre_archivo + "' type='video/mp4' ></video>";
                    } else {
                        document.getElementById("archivo").innerHTML =
                            "<img style='max-width:100%;' src='" + nombre_archivo + "'>";
                    }
                } else {
        ...
        $('#Modal_IMG').on('show.bs.modal', function(event) {
            ...
            if (imagen !== "") {
                if (imagen2 === "pdf") {
                    document.getElementById("dni_link").innerHTML = "<iframe height='700px' width='100%' src='" +
                        nombre_archivo + "'></iframe>";
                } else {
                    document.getElementById("dni_link").innerHTML = "<img style='max-width:100%;' src='" +
                        nombre_archivo + "' alt='Archivo'>";
                }
            } else {
            ...
            <nav id="sidebar">
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    ...
                    <li class="nav-item theme-text" style="margin-top: 8px; margin-bottom: 8px">
                        <a class="nav-link">
                            <img src="{{ asset('inicio/Grupo-LN1.png') }}" class="navbar-logo ajuste1"
                                alt="logo">
