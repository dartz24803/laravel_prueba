<table id="tabla_js_tmp" class="table" style="width:100%">
    <thead>
    ...
    <tbody>
        @foreach ($list_temporal as $list)
            <tr class="text-center">
                ...
                <td>
                    @if ($list->archivo!="")
                        <a title="Archivo" href="{{ $list->archivo }}" target="_blank">
                    ...
                    @endif
                    <a href="javascript:void(0);" title="Eliminar" onclick="Delete_Temporal('{{ $list->id_temporal }}')">
