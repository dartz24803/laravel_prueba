...
@section('content')
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="toolbar d-md-flex align-items-md-center mt-3">
                            <div class="col-lg-12 d-flex justify-content-end">
                                ...
                                onclick="Excel_Capacitacion_Cajero();">
                        ...
                        <div class="table-responsive" id="lista_capacitacion_cajero">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#capacitaciones_cajeros").addClass('active');

            Lista_Capacitacion_Cajero();
        });

        function Lista_Capacitacion_Cajero(){
            Cargando();

            var url = "{{ route('capacitacion_cajero.list') }}";
            ...
            $.ajax({
                ...
                success:function (resp) {
                    $('#lista_capacitacion_cajero').html(resp);
                }
            });
        }

        function Excel_Capacitacion_Cajero(){
            window.location.replace("{{ route('capacitacion_cajero.excel') }}");
        }
    </script>
@endsection