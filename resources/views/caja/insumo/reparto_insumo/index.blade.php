    ...
    <div class="col-lg-6">
        <div class="toolbar d-flex">
            <div class="col-lg-12 d-flex justify-content-end">
                <button type="button" class="btn btn-primary" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" app_reg="{{ route('insumo_ra.create') }}">
...
<script>
    ...
    function Lista_Izquierda(){
        ...
        var url = "{{ route('insumo_ra.list_izquierda') }}";
    ...
    function Lista_Derecha(){
        ...
        var url = "{{ route('insumo_ra.list_derecha') }}";
    ...
    function Delete_Reparto_Insumo(id) {
        Cargando();

        var url = "{{ route('insumo_ra.destroy', ':id') }}".replace(':id', id);
    ...
    function Excel_Izquierda(){
        window.location.replace("{{ route('insumo_ra.excel_izquierda') }}");
    }

    function Excel_Derecha(){
        window.location.replace("{{ route('insumo_ra.excel_derecha') }}");
    }
</script>