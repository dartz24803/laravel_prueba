<div class="toolbar d-md-flex align-items-md-center mt-3">
    ...
    <div class="col-lg-4">
        ...
        session('usuario')->id_nivel == "1")
            <button type="button" class="btn btn-primary mb-2 mb-sm-0 mb-md-2 mb-lg-0" title="Buscar"
            data-toggle="modal" data-target="#ModalRegistro" app_reg="{{ route('insumo_sa.create') }}">
