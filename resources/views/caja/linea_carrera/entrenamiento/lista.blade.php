...
<table id="tabla_js" class="table" style="width:100%">
    ...
    <tbody>
        @foreach ($list_cesado as $list)
            <tr class="text-center" style="background-color:@php if($list->fec_baja!="" && $list->fec_baja!="0000-00-00"){ echo "#ff000036"; } @endphp">
                <td>{{ $list->orden }}</td>
                <td>
                    @if ($list->generacion!="")
                        <div class="d-flex">
                ...
                <td>{{ $list->dias_laborados }}</td>
                <td class="text-center">
                    @if (session('usuario')->id_puesto=="27")
                        {{-- Aquí va el ojo --}}
                    @else
                            ...
                            <a href="javascript:void(0);" title="Mail">
                                <svg style="width: 20px !important;height: 20px !important;" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g fill="blue">
                                        ...
                                        <g>
                                            <rect height="14" width="216" x="148" y="209.2" fill="blue" id="XMLID_6_"/><polygon points="148,241 162.3,250.9 349.7,250.9 364,241 364,236.9 148,236.9" fill="blue" id="XMLID_5_"/>
                        ...
                        @else
                            <a title="Mail" href="javascript:void(0);" onclick="Envio_Email('{{ $list->id_usuario }}')">
                                <svg style="width: 20px !important;height: 20px !important;" data-name="Layer 1" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        <style>.cls-1{fill:none;stroke:#d13d61;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px;}</style>
                                    </defs>
                        ...
                        @if ($list->foto!="")
                            <a href="{{ route('colaborador_ce.download', $list->id_usuario) }}" title="Descargar Foto">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                            </a>
                        @endif

                        <a href="javascript:void(0);" title="Editar" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ route('colaborador_ce.edit', $list->id_usuario) }}">
                        ...
                        {{--
                            <a href="{{ route('colaborador_ce.pdf_perfil', $list->id_usuario) }}" target="_blank" title="pdf">
                        ...
                        @if ($list->documento!="" || $list->documento!=null)
                            <a href="https://lanumerounocloud.com/intranet/MiEquipo_ComunicarBaja/{{ $list->documento }}" target="_blank" title="Motivo Renuncia">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="red" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-down"><polyline points="7 13 12 18 17 13"></polyline><polyline points="7 6 12 11 17 6"></polyline></svg>
                            </a>
                        @endif
                    @endif
                </td>
