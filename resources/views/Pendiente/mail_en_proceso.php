                                    ...
                                    <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                        <tr>
                                            <td align="left" class="mobile-padding" style="padding-top: 20px;">
                                                ...
                                                <h2 class="mediocuadrado">En Proceso</h2><br>
                                                    ¡Hola <?php if(isset($get_ticket[0]['nom_solicitante'])){ echo $get_ticket[0]['nom_solicitante']; }?>!<br><br>
                                                    Tu REQUERIMIENTO registrado el día <?php echo $get_ticket[0]['fecha_registro']; ?> se encuentra en proceso de atención.<br><br>
                                                    ...
                                                    <span style="color:#00B1F4;font-weight:bold;">Puntualidad</span><br>
                                                    Enfocada al cumplimiento de nuestras actividades a tiempo
                                            </td>
                                        </tr>
                                    </table>
                                </center>
