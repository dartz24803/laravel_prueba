<form id="formularioi" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class="modal-body" style="max-height:700px; overflow:auto;">
        <div class="row">
            ...
            <div class="form-group col-lg-6">
                ...
                <input type="file" class="form-control-file" name="exceli" id="exceli" 
                onchange="Validar_Excel('exceli');">
            </div>
        </div>
    </div>
    ...
    <div class="modal-footer">
        @csrf
        <button class="btn btn-primary" type="button" onclick="Importar_Registro_Letra();">Guardar</button>
        <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Cancelar</button>
    </div>
</form>

<script>
    function Importar_Registro_Letra() {
        Cargando();

        var dataString = new FormData(document.getElementById('formularioi'));
        var url = "{{ route('registro_letra.store_imp') }}";
