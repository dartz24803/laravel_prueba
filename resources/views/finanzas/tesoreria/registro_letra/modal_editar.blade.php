<form id="formularioe" method="POST" enctype="multipart/form-data" class="needs-validation">
    <div class="modal-header">
        <h5 class="modal-title">Editar cheque / letra:</h5>
    ...
    <div class="modal-footer">
        @csrf
        @method('PUT')
        <button class="btn btn-primary" type="button" onclick="Update_Registro_Letra();">Guardar</button>
...
<script>
    ...
    function Update_Registro_Letra() {
        Cargando();

        var dataString = new FormData(document.getElementById('formularioe'));
        var url = "{{ route('registro_letra.update', $get_id->id_cheque_letra) }}";
