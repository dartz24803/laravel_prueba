                            ...
                            <div class="items">
                                <div class="item-content">
                                    ...
                                    <div class="user-email">
                                        ...
                                        <p class="usr-email-addr" style="text-transform:lowercase;" onkeyup="javascript:this.value=this.value.toLowerCase();"><?php echo $list['emailp']; ?> </p>
                                    </div>
                                </div>
                            </div>
                        <?php } ?> 
