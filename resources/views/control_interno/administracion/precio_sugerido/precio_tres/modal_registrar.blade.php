<form id="formulario" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class="modal-body" style="max-height:700px; overflow:auto;">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-4">
                <input type="text" class="form-control" id="precio_3" name="precio_3" placeholder="Precio x 3" 
                onkeypress="return solo_Numeros_Punto(event);">
            </div>
        </div>
    </div>
    ...
    <div class="modal-footer">
        @csrf
        <button class="btn btn-primary" type="button" onclick="Insert_Precio_Tres();">Guardar</button>
        <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Cancelar</button>
    </div>
</form>

<script>
    function Insert_Precio_Tres() {
        Cargando();

        var dataString = new FormData(document.getElementById('formulario'));
        var url = "{{ route('precio_sugerido_conf_tr.store') }}";
