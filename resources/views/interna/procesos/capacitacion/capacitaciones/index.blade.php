...
<div class="toolbar d-md-flex align-items-md-center mt-3">
    ...
    <div class="col-lg-4 col-xl-6">
        ...
        <button type="button" class="btn btn-primary" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" app_reg="{{ route('portalprocesos_cap.create') }}">
        ...
        <!-- <a class="btn mb-2 mb-sm-0 mb-md-2 mb-lg-0" style="background-color: #28a745 !important;" ">
...
<script>
    ...
    function Lista_Capacitaciones() {
        Cargando();

        var url = "{{ route('portalprocesos_cap.list') }}";
