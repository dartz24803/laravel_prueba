...
<table id="tabla_js" class="table table-hover" style="width:100%">
    ...
    <tbody>
        ...
        <tr class="text-center">
            ...
            <td>
                <a href="javascript:void(0);" title="Editar" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ route('portalprocesos_lm.edit', $proceso->id_portal) }}">
                ...
                @endif
                <a href="javascript:void(0);" title="Ver Contenido" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ route('portalprocesos_lm.image', $proceso->id_portal_historial) }}">
