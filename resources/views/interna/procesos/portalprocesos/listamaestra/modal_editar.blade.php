...
<form id="formularioe" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class="modal-body" style=" max-height:450px;  overflow:auto;">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="documento-tab" data-toggle="tab" href="#documento" role="tab"
                    aria-controls="documento" aria-selected="true">Documento</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="accesos-tab" data-toggle="tab" href="#accesos" role="tab"
                    aria-controls="accesos" aria-selected="false">Accesos</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="versiones-tab" data-toggle="tab" href="#versiones" role="tab"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input class="form-control" type="date" name="fecha" id="fecha"
                                    value="{{ isset($get_id->fecha) ? date('Y-m-d', strtotime($get_id->fecha)) : date('Y-m-d') }}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <span id="miLabel" class="form-control"
                                        style="color:black">{{ $get_id->codigo }}</span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class=" form-group col-md-3">
                                ...
                                <select class="form-control" id="estadoe" name="estadoe">
                                    <option value="0" {{ $get_id->estado_registro == 0 ? 'selected' : '' }}>
                                        Publicado</option>
                                    <option value="1" {{ $get_id->estado_registro == 1 ? 'selected' : '' }}>Por
                                        aprobar</option>
                                    <option value="2" {{ $get_id->estado_registro == 2 ? 'selected' : '' }}>
                                        Publicado</option>
                                    <option value="3" {{ $get_id->estado_registro == 3 ? 'selected' : '' }}>Por
                                        actualizar</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="hidden" name="versione" id="versione"
                                    value="{{ $get_id->version }}">
                                <span id="miVersion" class="form-control"
                                    style="color:black">{{ $get_id->version }}</span>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <input type="file" class="form-control-file" name="archivo1e" id="archivo1e"
                                        onchange="Valida_Archivo('archivo1e');">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <input type="file" class="form-control-file" name="documentoae"
                                        id="documentoae" onchange="Validar_Archivo_Backup('documentoae');">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="d-flex align-items-center">
                                    <input type="file" class="form-control-file" name="diagramaae"
                                        id="diagramaae" onchange="Validar_Archivo_Backup('diagramaae');">
                                </div>
                            </div>
                        </div>
                    ...
                    <table id="tabla_js2" class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="javascript:void(0);" title="Eliminar" onclick="Delete_Proceso('{{ $proceso->id_portal_historial }}')">
    ...
    <div class="modal-footer">
        ...
        <button id="boton_disablede" class="btn btn-primary" type="button"
            onclick="Update_Proceso();">Guardar</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#id_area_acceso_e').on('change', function() {
            ...
            console.log('Selected Areas:',
                selectedAreas); // Para verificar que los valores se están obteniendo correctamente
    ...
    function Acceso_Todo() {
        ...
        if (isChecked) {
            ...
            $("#id_area_acceso_e").append('<option value="all" disabled selected>Seleccionado todo</option>').trigger(
                'change');
            $("#id_area_p").append('<option value="all" disabled selected>Seleccionado todo</option>').trigger(
                'change');
            $("#tipo_acceso_p").append('<option value="all" disabled selected>Seleccionado todo</option>').trigger(
                'change');
            $("#tipo_acceso_e").append('<option value="all" disabled selected>Seleccionado todo</option>').trigger(
                'change');
