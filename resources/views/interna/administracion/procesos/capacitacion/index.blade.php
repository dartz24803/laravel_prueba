<div class="toolbar d-flex">
    <div class="col-lg-12 d-flex justify-content-end">
        <button type="button" class="btn btn-primary" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" app_reg="{{ route('portalprocesos_cap_conf.create') }}">
...
<script>
    ...
    function Lista_Capacitaciones() {
        ...
        var url = "{{ route('portalprocesos_cap_conf.list') }}";
    ...
    function Delete_Capacitacion(id) {
        ...
        var url = "{{ route('portalprocesos_cap_conf.destroy', ':id') }}".replace(':id', id);
