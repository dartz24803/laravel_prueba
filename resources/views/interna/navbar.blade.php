...
@if (session('acceso_pp'))
<li class="menu" id="tablasoporte">
    <a href="{{ url('tablagenerales') }}" id="htablasoporte" aria-expanded="false" class="dropdown-toggle" data-toggle="tooltip" data-html="true">
        <div class="">
            ...
            <span title="Tabla de Soporte">Tabla de Soporte</span>
        </div>
    </a>
</li>
@endif
...
<li class="menu" id="conf_sistemas">
    <a href="#rconf_sistemas" id="hconf_sistemas" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        <div class="">
    ...
    <ul class="collapse submenu list-unstyled" id="rconf_sistemas" data-parent="#accordionExample">
        <li id="conf_tickets">
            <a href="{{ route('ticket_conf') }}" data-toggle="tooltip" data-placement="right" data-html="true">
                <p class="romperpalabra"><span id="icono_active2"></span> Ticket</p>
            </a>
        </li>
    </ul>
</li>
