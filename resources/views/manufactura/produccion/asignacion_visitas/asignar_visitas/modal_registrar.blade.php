...
<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class=" modal-header">
        <h5 class="modal-title">Registrar Asignación Visita111</h5>
...
<script>
    ...
    function Insert_Funcion_Temporal() {
        ...
        // Validar si tableData está vacío
        if (tableData.length === 0) {
            swal.fire(
                'Advertencia!',
                'Debe agregar al menos un punto de partida y llegada.',
                'warning'
            );
            return; // Detener la ejecución si no hay datos en la tabla
        }
