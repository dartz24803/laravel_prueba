    ...
    <tbody>
        @foreach ($list_proveedor as $list)
            <tr class="text-center">
                ...
                <td class="text-left">{{ $list->responsable }}</td>
                <td>
                    {{ $list->celular_proveedor }}
                    @if ($list->celular_proveedor!="")
                        <a href="tel:+51{{ $list->celular_proveedor }}">
