    ...
    <tbody>
        @foreach ($list_proveedor as $list)
            <tr class="text-center">
                ...
                <td>
                    <a href="javascript:void(0);" title="Editar" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ route('avisita_conf_pta.edit', $list->id_proveedor) }}">
