...
<li class="menu" id="reportbiseguridad">
    <a href="#rreportbiseguridad" id="hreportbiseguridad" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        <div class="">
    ...
    <ul class="collapse submenu list-unstyled" id="rreportbiseguridad" data-parent="#accordionExample">
