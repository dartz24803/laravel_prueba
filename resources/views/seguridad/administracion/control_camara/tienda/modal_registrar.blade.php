<form id="formulario" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class="modal-body" style="max-height:700px; overflow:auto;">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-10">
                <select class="form-control multivalue" name="id_local[]" id="id_local" multiple="multiple">
    ...
    <div class="modal-footer">
        @csrf
        <button class="btn btn-primary" type="button" onclick="Insert_Tienda();">Guardar</button>
...
<script>
    ...
    function Insert_Tienda() {
        Cargando();

        var dataString = new FormData(document.getElementById('formulario'));
        var url = "{{ route('control_camara_conf_ti.store') }}";
