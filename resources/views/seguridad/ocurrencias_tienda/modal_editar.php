...
<form id="formulario_ocurrenciae" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class="modal-body" style="max-height:520px; overflow:auto;">
        <div class="col-md-12 row"> 
            ...
            <div class="form-group col-md-4" id="div_tipo_oe">
                <select class="form-control" name="id_tipoe" id="id_tipoe" onchange="Tipo_Piochae();">
                    ...
                    <?php foreach ($list_tipo as $list) { ?>
                        <option value="<?php echo $list['id_tipo_ocurrencia']; ?>" <?php if($get_id[0]['id_tipo']==$list['id_tipo_ocurrencia']){echo "selected";}?>><?php echo $list['nom_tipo_ocurrencia']; ?></option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="form-group col-md-4">
                <input type="date" class="form-control" id="fec_ocurrenciae" name="fec_ocurrenciae" value="<?php echo date("Y-m-d"); ?>" >
            </div>
            ...
            <div class="form-group col-md-4">
                <select class="form-control" name="id_gestione" id="id_gestione">
                    ...
                    <?php foreach ($list_gestion as $list) { ?>
                        <option value="<?php echo $list['id_gestion']; ?>" <?php if($get_id[0]['id_gestion']==$list['id_gestion']){echo "selected";}?>><?php echo $list['nom_gestion']; ?></option>
                    <?php } ?>
                </select>
            </div>
    ...
    <div class="modal-footer">
        <input type="hidden" class="form-control" id="cod_basee" name="cod_basee" value="<?php echo $get_id[0]['cod_base']; ?>" >
        ...
        <button class="btn btn-primary mt-3" type="button" onclick="Edit_Ocurrencia_Tienda();">Guardar</button>
