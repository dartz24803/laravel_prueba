<form id="formulario" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class="modal-body" style="max-height:700px; overflow:auto;">
        <div class="row">
            ...
            <div class="form-group col-lg-4">
                <input type="date" class="form-control" name="date_input" id="date_input" value="{{ date('Y-m-d') }}">
            </div>
            ...
            <div class="form-group col-lg-4">
                <select class="form-control" name="cod_base" id="cod_base" onchange="Traer_Suministro('');">
    ...
    <div class="modal-footer">
        @csrf
        <input type="hidden" id="lect_ant">
        <button class="btn btn-primary" type="button" onclick="Insert_Gestion_Servicio();">Guardar</button>
        <button class="btn" data-dismiss="modal"><i class="flaticon-cancel-12"></i> Cancelar</button>
    </div>
</form>

<script>
    function Insert_Gestion_Servicio() {
        Cargando();

        var dataString = new FormData(document.getElementById('formulario'));
        var url = "{{ route('lectura_servicio_ges.store') }}";
            ...
            success: function(data) {
                if(data=="parametro"){
                    Swal({
                        ...
                        if (result.value) {
                            var dataString = new FormData(document.getElementById('formulario'));
                            var url = "{{ route('lectura_servicio_ges.store_directo') }}";
