...
@section('content')
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="toolbar d-flex mt-3 align-items-center bg-white">
                            ...
                            <div class="col-lg-6">
                                ...
                                <button type="button" class="btn btn-primary" title="Registrar" onclick="Valida_Modal('');">
                                ...
                                <a id="modal_apertura_cierre" data-toggle="modal" data-target="#ModalRegistro" app_reg="{{ route('apertura_cierre.create') }}"></a>

                                <a class="btn" style="background-color: #28a745 !important;" onclick="Excel_Apertura_Cierre();">
    ...
    <script>
        ...
        function Valida_Modal(v){
            ...
            var url = "{{ route('apertura_cierre.valida_modal') }}";
            var csrfToken = $('input[name="_token"]').val();
        ...
        function Excel_Apertura_Cierre() {
            ...
            var fec_ini = $('#fecha_iniciob').val();
            var fec_fin = $('#fecha_finb').val();
            window.location = "{{ route('apertura_cierre.excel', [':cod_base', ':fec_ini', ':fec_fin']) }}".replace(':cod_base', cod_base).replace(':fec_ini', fec_ini).replace(':fec_fin', fec_fin);
        }
    </script>
@endsection