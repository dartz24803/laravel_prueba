...
<table id="zero-config" class="table table-hover non-hover" style="width:100%">
    ...
    <tbody>
        <?php foreach($list_tickets as $list) {  ?>    
            <tr>
                ...
                <td>
                    <input type="date" class="form-control" id="f_fin_<?php echo $list['id_tickets']; ?>" 
                    name="f_fin_<?php echo $list['id_tickets']; ?>" 
                    value="<?php echo $list['f_fin']?>" 
                    onblur="Update_Vence_Ticket('<?php echo $list['id_tickets']; ?>')" 
                    style="display:none;padding: 0px;margin-top: -20px;">
                    <span onclick="Mostrar_Vence_Ticket('<?php echo $list['id_tickets']; ?>')" 
                    id="span_vence_<?php echo $list['id_tickets']; ?>">
                        <?php echo $list['vence']; ?>
                    </span>
                </td>
                <td>
                ...
                <td class="text-center">
                    <div class="btn-group dropleft" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnDropLeft" style="padding:0;">
                            ...
                            <a class="dropdown-item" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ url('Tickets/Modal_Update_Tickets_Admin/'. $list['id_tickets']) }}" style="cursor:pointer;">Editar</a>
