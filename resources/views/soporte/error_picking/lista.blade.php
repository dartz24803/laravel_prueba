...
<table id="tabla_js" class="table table-hover" style="width:100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0);" title="Editar" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ route('errorespicking.edit', $list->id) }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success">
                        <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                    </svg>
                </a>

                <a href="javascript:void(0);" title="Ver" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ route('errorespicking.ver', $list->id) }}">
                ...
                <a href="javascript:void(0);" title="Eliminar" onclick="Delete_ErroresPicking('{{ $list->id }}')">
