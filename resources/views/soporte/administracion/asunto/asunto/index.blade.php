<div class="toolbar d-flex">
    <div class="col-lg-12 d-flex justify-content-end">
        <button type="button" class="btn btn-primary" title="Registrar" data-toggle="modal" data-target="#ModalRegistro"
            app_reg="{{ route('soporte_asunto_conf.create') }}">
...
<script>
    ...
    function Lista_Asuntos() {
        Cargando();

        var url = "{{ route('soporte_asunto_conf.list') }}";
    ...
    function Delete_Asunto(id) {
        ...
        var url = "{{ route('soporte_asunto_conf.destroy', ':id') }}".replace(':id', id);
