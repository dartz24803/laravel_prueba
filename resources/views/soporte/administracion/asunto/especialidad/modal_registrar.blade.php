<form id="formulario" method="POST" enctype="multipart/form-data" class="needs-validation">
    <div class="modal-header">
        <h5 class="modal-title">Registrar Nuevo Especialidad:</h5>
    ...
    <div class="modal-footer">
        @csrf
        <button class="btn btn-primary" type="button" onclick="Insert_Especialidad();">Guardar</button>
...
<script>
    function Insert_Especialidad() {
        ...
        var url = "{{ route('soporte_especialidad_conf.store') }}";
