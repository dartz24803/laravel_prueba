<table id="tabla_js" class="table" style="width:100%">
    ...
    <tbody>
        @foreach ($list_area_especificas as $list)
            <tr class="text-center">
                ...
                <td>
                    <a href="javascript:void(0);" title="Editar" data-toggle="modal" data-target="#ModalUpdate"
                        app_elim="{{ route('soporte_area_esp_conf.edit', $list->idsoporte_area_especifica) }}">
                    ...
                    <a href="javascript:void(0);" title="Eliminar"
                        onclick="Delete_AreaEspecifica('{{ $list->idsoporte_area_especifica }}')">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
