    ...
    <div class="modal-body" style="max-height:700px; overflow:auto;">
        <div class="row"> <!-- Add this row class to create a horizontal layout -->
            <div class="form-group col-lg-12">
                <label for="nom_unie">Nombre:</label>
                <input type="text" class="form-control" id="nom_unie" name="nom_unie"
                    value="{{ $get_id->nom_unidad }}">
            </div>
...
<script>
    function Update_Articulo() {
        ...
        var url = "{{ route('consumible_uni.update', $get_id->id_unidad) }}";
