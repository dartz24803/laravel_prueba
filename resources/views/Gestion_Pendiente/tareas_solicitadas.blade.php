<div class="toolbar d-flex">
    <div class="col-lg-2">
        ...
        <div class="col-md-12">
            <input type="checkbox" id="cproceso" checked name="cproceso" value="2" onchange="Lista_Tareas_Solicitadas()">
            <label for="cproceso" style="font-weight:normal">En Proceso</label>
        </div>
        <div class="col-md-12">
            <input type="checkbox" id="cfinalizado" name="cfinalizado" value="3" onchange="Lista_Tareas_Solicitadas()">
            <label for="cfinalizado" style="font-weight:normal">Completado</label>
        </div>
        <div class="col-md-12">
            <input type="checkbox" id="cstandby" name="cstandby" value="4" onchange="Lista_Tareas_Solicitadas()">
