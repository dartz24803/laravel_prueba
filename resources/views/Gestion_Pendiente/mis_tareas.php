...
<script>
    ...
    function Lista_Mis_Tareas(tipo){
        ...
        var url = "<?php echo site_url(); ?>Corporacion/Lista_Mis_Tareas";
    ...
    function Excel_Gestion_Pendiente() {
        ...
        window.location ="<?php echo site_url(); ?>Corporacion/Excel_Gestion_Pendiente/"+id_area+"/"+base+"/"+cpiniciar+"/"+cproceso+"/"+cfinalizado+"/"+cstandby+"/"+mis_tareas+"/"+mi_equipo+"/"+responsablei;
    }
</script>