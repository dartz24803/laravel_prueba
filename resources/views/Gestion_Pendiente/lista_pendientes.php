    ...
    <tbody>
        <?php foreach($list_gestion_pendiente as $list) {  ?>   
            <tr>
                ...
                <td data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Corporacion/Modal_Update_Gestion_Pendiente') ?>/<?php echo $list['id_pendiente']; ?>" style="cursor:pointer"><?php echo $list['fecha_tabla']; ?></td>
                <td data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Corporacion/Modal_Update_Gestion_Pendiente') ?>/<?php echo $list['id_pendiente']; ?>" style="cursor:pointer"><?php echo $list['cod_base']; ?></td>
                <td data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Corporacion/Modal_Update_Gestion_Pendiente') ?>/<?php echo $list['id_pendiente']; ?>" style="cursor:pointer"><?php echo ucfirst($list['nom_area_min']); ?></td> 
                <td data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Corporacion/Modal_Update_Gestion_Pendiente') ?>/<?php echo $list['id_pendiente']; ?>" style="cursor:pointer"><?php echo ucfirst($list['titulo_min']); ?></td>
                <td data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Corporacion/Modal_Update_Gestion_Pendiente') ?>/<?php echo $list['id_pendiente']; ?>" style="cursor:pointer"><?php echo ucwords($list['responsable']); ?></td>
                <td>
                ...
                <td class="text-center">
                    <div class="btn-group dropleft" role="group">
                        ...
                        <div class="dropdown-menu" aria-labelledby="btnDropLeft" style="padding:0;">
                            <a class="dropdown-item"  data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Corporacion/Modal_Ver_Gestion_Pendiente') ?>/<?php echo $list['id_pendiente']; ?>" style="cursor:pointer;">Ver</a>
                            <a class="dropdown-item" data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Corporacion/Modal_Update_Gestion_Pendiente') ?>/<?php echo $list['id_pendiente']; ?>" style="cursor:pointer;">Editar</a>    
