        ...
        <?php foreach($list_tracking as $list){ ?>
            <tr class="text-center">
                ...
                <td>
                    ...
                    <?php }else if($list['id_estado']==3){ ?>
                        <a href="<?= site_url('Tracking/Detalle_Transporte') ?>/<?= $list['id']; ?>" title="Detalle de transporte">
...
<script>
    ...
    function Insert_Salida_Mercaderia(id) {
        ...
        var url = "<?= site_url(); ?>Tracking/Insert_Salida_Mercaderia";
    ...
    function Insert_Llegada_Tienda(id) {
        ...
        var url = "<?= site_url(); ?>Tracking/Insert_Llegada_Tienda";
    ...
    function Insert_Confirmacion_Llegada(id) {
        ...
        var url = "<?= site_url(); ?>Tracking/Insert_Confirmacion_Llegada";
    ...
    function Verificacion_Fardos(id) {
        ...
        var url = "<?= site_url(); ?>Tracking/Insert_Cierre_Inspeccion_Fardos";
        ...
        Swal({
            ...
            if (result.value) {
                ...
                window.location = "<?php echo site_url(); ?>Tracking/Verificacion_Fardos/"+id;
            }
        })
    }
