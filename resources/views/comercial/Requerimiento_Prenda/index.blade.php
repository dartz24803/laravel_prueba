                        ...
                        <form id="formulario" class="control">
                            <div class="col-md-12 row">
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-control" id="anioi" name="anioi" onchange="Buscar_Requerimiento_Prenda();">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <select class="form-control" id="mesi" name="mesi" onchange="Buscar_Requerimiento_Prenda();">
                                        <option value="0">Seleccione</option>
...
$(document).ready(function() {
    ...
    function Buscar_Requerimiento_Prenda() {
        Cargando();

        var anio=$('#anioi').val();
        var mes=$('#mesi').val();
        var url = "{{ url('RequerimientoPrenda/Busqueda_Requerimiento_Prenda') }}";
