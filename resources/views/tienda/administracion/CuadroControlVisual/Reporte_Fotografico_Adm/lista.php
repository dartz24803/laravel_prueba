        ...
        <?php foreach ($list as $row) {  ?>
            <tr>
                ...
                <td class="text-center">
                    <a href="javascript:void(0);" title="Editar" data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Tienda/Modal_Update_Registro_Fotografico_Adm') ?>/<?php echo $row['id']; ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success">
                            <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                        </svg>
                    </a>
                    <?php if ($_SESSION['usuario'][0]['centro_labores'] == "OFC") {?>
                    <a href="javascript:void(0);" class="" title="Eliminar" onclick="Delete_Reporte_Fotografico_Adm('<?php echo $row['id']; ?>')" id="delete" role="button">
...
<script>
    ...
    function Delete_Reporte_Fotografico_Adm(id) {
        ...
        var id = id;
        var url = "<?php echo site_url(); ?>Tienda/Delete_Reporte_Fotografico_Adm";
        Swal({
