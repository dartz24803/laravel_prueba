<div class="d-flex justify-content-between align-items-center">
    ...
    <div class="col-lg-10 d-flex justify-content-end">
        <button type="button" class="btn btn-primary" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" app_reg="{{ url('Modal_Programacion_Diaria') }}">
...
<script>
    ...
    function Lista_Programacion_Diaria() {
        ...
        var base = $('#base').val();
        var url = "{{ url('Lista_Programacion_Diaria') }}";
