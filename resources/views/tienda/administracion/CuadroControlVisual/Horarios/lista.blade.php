        ...
        <?php foreach ($list_horarios as $list) {  ?>
            <tr class="text-center">
                ...
                <td>
                    ...
                    <a href="javascript:void(0);" title="Agregar horario al puesto" data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Tienda/Modal_Agregar_Horarios_Cuadro_Control') ?>/<?php echo $list['id_horarios_cuadro_control']; ?>">
                ...
                <td class="text-center">
                    <a href="javascript:void(0);" title="Editar" data-toggle="modal" data-target="#ModalUpdate" app_elim="<?= site_url('Tienda/Modal_Update_Horarios_Cuadro_Control') ?>/<?php echo $list['id_horarios_cuadro_control']; ?>">
