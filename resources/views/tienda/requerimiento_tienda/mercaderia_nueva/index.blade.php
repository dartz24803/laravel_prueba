<div class="row mr-1 ml-1 mt-2">
    <div class="form-group col-md-6 col-lg-2">
        <label>Año:</label>
        <select class="form-control" id="aniob" name="aniob" onchange="Lista_Mercaderia_Nueva();">
    ...
    <div class="form-group col-md-6 col-lg-2">
        <label>Semana:</label>
        <select class="form-control" id="semanab" name="semanab" onchange="Lista_Mercaderia_Nueva();">
            <option value="0">Todos</option>
    ...
    <div class="form-group col-md-6 col-lg-2">
        <label>Estado:</label>
        <select class="form-control" id="estadob" name="estadob" onchange="Lista_Mercaderia_Nueva();">
    ...
    <div class="col-md-3 col-lg-2 mt-2 mt-lg-0 mb-2 mb-md-0 d-flex align-items-center justify-content-start">
    ...
    <div class="col-md-3 col-lg-4 d-flex align-items-center">
        <a class="btn" style="background-color: #28a745 !important;" onclick="Excel_Mercaderia_Nueva();">
...
<div class="table-responsive" id="lista_mercaderia_nueva">
</div>
...
<script>
    ...
    function Lista_Mercaderia_Nueva(){
        ...
        var url = "{{ route('trequerimiento_tienda_mn.list') }}";

        $.ajax({
            url: url,
            type: "POST",
            data: {'anio':anio,'semana':semana,'estado':estado},
            headers: {
    ...
    function Excel_Mercaderia_Nueva() {
        ...
        var semana = $('#semanab').val();
        var estado = $('#estadob').val();
        window.location = "{{ route('trequerimiento_tienda_mn.excel', [':anio', ':semana', ':estado']) }}".replace(':anio', anio).replace(':semana', semana).replace(':estado', estado);
    }
</script>