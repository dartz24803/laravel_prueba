<div class="toolbar d-flex">
    ...
    <div class="col-lg-10 d-flex justify-content-end align-items-center">
        ...
        session('usuario')->id_puesto==29 || session('usuario')->id_puesto==311)
            <button type="button" class="btn btn-primary" title="Registrar" data-toggle="modal" data-target="#ModalRegistroGrande" app_reg_grande="{{ route('administrador_sc.create') }}">
