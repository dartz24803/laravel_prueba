...
@section('content')
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="toolbar d-flex mt-3">
                            <div class="form-group col-lg-5">
                                ...
                                <select class="form-control basic" id="id_asignado" name="id_asignado" onchange="Lista_Funcion_Temporal();">
                        ...
                        @csrf
                        <div class="table-responsive mt-4" id="lista_funcion_temporal">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#funciones_temporales").addClass('active');
