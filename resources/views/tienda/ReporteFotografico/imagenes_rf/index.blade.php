...
<div class="toolbar d-flex mt-4">
    ...
    $disabled = '';
    $selected = '';
    if ($base == 'OFC' || Session('usuario')->id_puesto == 251 || Session('usuario')->id_puesto == 131 || Session('usuario')->id_puesto == 144 || Session('usuario')->id_puesto == 74 || Session('usuario')->id_puesto == 73) {
        $disabled = '';
        $selected = 'selected';
    } else {
        $disabled = 'disabled';
