    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        <div class="row">
            ...
            <div class="form-group col-lg-6">
                ...
                <div class="">
                    <input type="file" class="form-control-file" id="archivo" name="archivo" onchange="return Validar_Archivo('archivo')" />
                </div>
            </div>
            <div class="form-group col-lg-12">
                <label class="control-label text-bold">Formato: </label>
                <div class="">
                    <a class="btn mb-2 mr-2" style="background-color: #28a745 !important;" onclick="Formato_Carga_Inventario();">
...
<script>
    ...
    function Formato_Carga_Inventario() {
        Cargando();

        var url = "{{ route('cargainventario.formato') }}";
