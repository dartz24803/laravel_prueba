                ...
                <div class="widget-content widget-content-area br-2">
                    <div class="toolbar d-flex p-4">
                        ...
                        <div class="form-group col-lg-1">
                            <button class="btn btn-primary mb-2 mr-2 form-control" type="button" onclick="Formato_Mercaderia_Fotografia();" style="background-color: #28a745!important;border-color:#28a745!important">
...
<script>
    ...
    function Delete_Requerimientos_Prendas(id) {
        Cargando();

        var url = "{{ route('mercaderiafotografia.destroy', ':id') }}".replace(':id', id);
