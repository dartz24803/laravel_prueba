<table id="zero-config" class="table table-hover" style="width:100%">
    <thead>
        <tr>
            ...
            <th>Total</th>
            <th>Estado</th>
            <th cass="no-content"><div align="center">Descargar</div></th>
        </tr>
    </thead>
    <tbody>
    <?php foreach($list_mercaderia as $list) {  ?>
        <tr>
            <td><?php echo $list['semana']; ?></td>
            <td><?php echo $list['Usuario']; ?></td>
            <td><?php echo $list['total']; ?></td>
            <td><?php if ($list['estado']=="1") {echo "Pendiente de Cierre";}
                      if ($list['estado']=="3") {echo "Cerrado";}?></td>
            <td class="text-center">
                <a class="btn mb-2 mr-2" style="background-color: #28a745 !important;" href="{{ url('MercaderiaExtraer/Excel_Mercaderia/'.$list['Usuario'].'/'.$list['semana'].'/'.$list['anio'].'/'.$list['cierre']) }}">
