            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="row mr-1 ml-1 mt-3">
                        <div class="col-lg-12 d-sm-flex justify-content-end">
                            <button type="button" class="btn btn-primary mb-2 mb-sm-0" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" app_reg="{{ url('Reproceso/Modal_Reproceso') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-square"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                                Registrar
                            </button>

                            <a class="btn mb-2 mb-sm-0" style="background-color: #28a745 !important;" onclick="Excel_Reproceso();">
                    ...
                    @csrf
                    <div class="table-responsive" id="lista_reproceso">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#reprocesos").addClass('active');

        Lista_Reproceso();
    });

    function Lista_Reproceso() {
        Cargando();

        var url = "{{ url('Reproceso/Lista_Reproceso') }}";
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#lista_reproceso').html(data);
            }
        });
    }

    function Delete_Reproceso(id) {
        Cargando();

        var url = "{{ url('Reproceso/Delete_Reproceso') }}";
        var csrfToken = $('input[name="_token"]').val();
    ...
    function Excel_Reproceso() {
        window.location ="{{ url('Reproceso/Excel_Reproceso') }}";
    }
</script>
