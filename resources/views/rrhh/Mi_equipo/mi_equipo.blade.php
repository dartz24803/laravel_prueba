<div class="toolbar d-flex">
    ...
    <div class="col-lg-9 d-flex align-items-center">
        <button type="button" class="btn" style="background-color: #28a745 !important;" onclick="EquipoExcel();" title="Excel">
...
@csrf
<div id="lista_equipo" class="table-responsive mb-4 mt-4">
</div>
...
<script>
    ...
    function Cargar_x_Base(){
        Cargando();

        var base = $('#busq_base').val();
        var url = "{{ url('MiEquipo/Cargar_Bases_Equipo') }}/"+base;
    ...
    function EquipoExcel() {
        var base = $('#busq_base').val();
        window.location = "{{ url('MiEquipo/Excel_Mi_Equipo')}}/"+base;
    }
</script>