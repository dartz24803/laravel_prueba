                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="toolbar">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="cod_base" name="cod_base" class="form-control basic" onchange="Limpiar_Campos()">
                                                    ...
                                                    <?php foreach ($list_base as $list) { ?>
                                                        <option <?php if (($id_nivel == 1 || $id_nivel == 2) && $list['id_ubicacion'] == 23) {
                                                                    echo "selected";
                                                                } ?> value="<?php echo $list['id_ubicacion']; ?>"> <?php echo $list['cod_ubi']; ?> </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-1">
                                            <button class="btn btn-primary hidden-sm" type="button" onclick="Excel_Reporte_Asistencia();" title="Reporte de asistencia general" style="margin-top:33px;background-color: #28a745!important;border-color:#28a745!important">
                                        ...
                                        <div class="form-group col-md-1">
                                            <button class="btn btn-primary hidden-sm" type="button" onclick="Excel_Asistencia_Colaborador();" title="Excel Asistencia Colaboradores" style="margin-top:33px;background-color: #28a745!important;border-color:#28a745!important">
                                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="64" height="64" viewBox="0 0 172 172" style=" fill:#000000;">
                                                    <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                                                        <path d="M0,172v-172h172v172z" fill="none"></path>
                                                        <g fill="#ffffff">
        ...
        if (num_doc == '') {
            ...
            if (tipo == 2) {
                ...
                if (ini.isAfter(fin) == true) {
                    ...
                    var f1 = finicio;
                    var f2 = ffin;
                    window.location = "{{ url('Asistencia/Excel_Asistencia_Colaborador')}}/" + cod_mes + "/" + cod_anio + "/" + cod_base + "/" + num_doc + "/" + area + "/" + estado + "/" + tipo + "/" + finicio + "/" + ffin;
