...
<script>
    ...
    function Edit_Regimen() {
        var dataString = new FormData(document.getElementById('formulario_editar_regimen'));
        var url = "{{ url('ColaboradorConfController/Update_Regimen') }}";
