...
<form id="formulario_insert" method="POST" enctype="multipart/form-data" class="needs-validation">
    <div class="modal-header">
        <h5 class="modal-title">Registrar Programa</h5>
    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        <div class="row">
            ...
            <div class="form-group col-lg-2">
                <label class="control-label text-bold">Programas:</label>
            </div>
    ...
    <div class="modal-footer">
        <button class="btn btn-primary mt-3" onclick="Registrar_Programa();" type="button">Guardar</button>
...
<script>
    function Registrar_Programa() {
        ...
        var url = "{{ url('Registrar_Programa') }}";
