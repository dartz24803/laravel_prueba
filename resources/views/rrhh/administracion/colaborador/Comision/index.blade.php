...
@csrf
    <div class="table-responsive mb-4 mt-4">
        <table id="zero-configcomision" class="table table-hover" style="width:100%">
            <thead>
                <tr>
            ...
            <?php foreach($list_comision as $list) {  ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="javascript:void(0);" title="Editar" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ url('ColaboradorConfController/Modal_Update_Comision_AFP/'. $list['id_afp']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success">
                                <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                            </svg>
                        </a>
                        <a href="#" class="" title="Eliminar" onclick="Delete_Comision('<?php echo $list['id_afp']; ?>')" id="delete" role="button">
...
<script>
    $(document).ready(function() {
        document.title = 'Comisión';
                $('#zero-configcomision').DataTable({
...
function Delete_Comision(id){
    var id = id;
    var url="{{ url('ColaboradorConfController/Delete_Comision_AFP') }}";
