    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        <div class="row">
            ...
            <div class="form-group col-lg-10">
                <input class="form-control" type="text" id="pagina_acceso_e" name="pagina_acceso_e" value="<?= $get_id[0]['pagina_acceso']; ?>">
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <input name="id" id="id" type="hidden" value="<?= $get_id[0]['id']; ?>">
        <button class="btn btn-primary mt-3" onclick="Update_Pagina();" type="button">Guardar</button>
