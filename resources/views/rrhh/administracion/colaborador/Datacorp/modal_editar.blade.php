    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        <div class="row">
            ...
            <div class="form-group col-lg-10">
                <input class="form-control" type="text" id="carpeta_acceso_e" name="carpeta_acceso_e" value="<?= $get_id[0]['carpeta_acceso']; ?>">
            </div>
        </div>
    </div>
    <div class="modal-footer">
        <input name="id" id="id" type="hidden" value="<?= $get_id[0]['id']; ?>">
        <button class="btn btn-primary mt-3" onclick="Update_Datacorp();" type="button">Guardar</button>
...
<script>
    ...
    function Update_Datacorp() {
        Cargando();
        var csrfToken = $('input[name="_token"]').val();

        var dataString = new FormData(document.getElementById('formulario_update'));
        var url = "{{ url('Update_Datacorp') }}";
