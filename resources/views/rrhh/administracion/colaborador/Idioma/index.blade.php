<div class="d-flex justify-content-end align-items-center">
    <div class="col-lg-12 d-flex justify-content-end mb-4">
        <button type="button" class="btn btn-primary mb-2 mr-2" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" app_reg="<?= url('ColaboradorConfController/Modal_Idioma') ?>" >
...
<script>
    ...
    function Delete_Idioma(id) {
        var id = id;
        var url = "{{ url('ColaboradorConfController/Delete_Idioma') }}";
