            ...
            <div class="form-group col-md-4">
                <select name="basee" id="basee" class="form-control">
                    ...
                    <?php foreach ($list_base as $list) { ?>
                        <option value="<?php echo $list->cod_base ?>" <?php if ($get_id[0]['base'] == $list->cod_base) {
                                                                            echo "selected";
                                                                        } ?>><?php echo $list->cod_base ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
        <div class="col-md-12 row">
            ...
            <div class="form-group col-md-4">
                <select name="t_refrigerioe" id="t_refrigerioe" class="form-control" onchange="Tipo_Refrigerio('e')">
                    <option value="0">Seleccione</option>
                    <option value="1" <?php if ($get_id[0]['t_refrigerio'] == 1) {
                                            echo "selected";
                                        } ?>>Refrigerio Fijo</option>
                    <option value="2" <?php if ($get_id[0]['t_refrigerio'] == 2) {
                                            echo "selected";
                                        } ?>>Sin Refrigerio</option>
                </select>
            </div>
        </div>
        <div class="col-md-12 row">
            <div class="form-group col-md-2" id="div_refri1e" style="display:<?php if ($get_id[0]['t_refrigerio'] == 1) {
                                                                                    echo "block";
                                                                                } else {
                                                                                    echo "none";
                                                                                } ?>">
            ...
            <div class="form-group col-md-4" id="div_refri2e" style="display:<?php if ($get_id[0]['t_refrigerio'] == 1) {
                                                                                    echo "block";
                                                                                } else {
                                                                                    echo "none";
                                                                                } ?>">
            ...
            <div class="form-group col-md-2" id="div_refri3e" style="display:<?php if ($get_id[0]['t_refrigerio'] == 1) {
                                                                                    echo "block";
                                                                                } else {
                                                                                    echo "none";
                                                                                } ?>">
            ...
            <div class="form-group col-md-4" id="div_refri4e" style="display:<?php if ($get_id[0]['t_refrigerio'] == 1) {
                                                                                    echo "block";
                                                                                } else {
                                                                                    echo "none";
                                                                                } ?>">
        ...
        <div class="col-md-12 row">
            <div class="form-group col-md-1">
                <label class="switch s-primary mr-2">
                    <input type="checkbox" id="estado_registroe" name="estado_registroe" onclick="Estado_Turno_Ch()" <?php if ($get_id[0]['estado_registro'] == 1) {
                                                                                                                            echo "checked";
                                                                                                                        } ?> value="1">
            ...
            <div class="form-group col-md-1">
                <label id="lbl_estado_turno"><?php if ($get_id[0]['estado_registro'] == 1) {
                                                    echo "Activo";
                                                } else {
                                                    echo "Inactivo";
                                                } ?></label>
