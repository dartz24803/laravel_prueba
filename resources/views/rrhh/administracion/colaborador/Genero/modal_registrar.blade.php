<form id="formulario_registrar_genero" method="POST" enctype="multipart/form-data" class="needs-validation">
...
<script>
    ...
    function Insert_Genero() {
        var dataString = $("#formulario_registrar_genero").serialize();

        var url = "{{ url('ColaboradorConfController/Insert_Genero') }}";
