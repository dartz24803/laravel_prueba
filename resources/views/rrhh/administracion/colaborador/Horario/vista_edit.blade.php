<form id="formulario_horario_u" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class="modal-body" style="max-height:450px; overflow:auto;">
        ...
        <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
            ...
            <!--<li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile_u" role="tab" aria-controls="profile" aria-selected="false">Conf. Descanso</a>
            </li>-->
        </ul>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <!--<div class="tab-pane fade" id="profile_u" role="tabpanel" aria-labelledby="profile-tab">
                <div class="col-md-12 row conf_descanso_lu_u">
                    <?php 
                        $busq_detalle = in_array('1', array_column($get_detalle, 'dia'));
                        $posicion = array_search('1', array_column($get_detalle, 'dia'));
                        if ($busq_detalle != false){ 
                            $entrada = $get_detalle[$posicion]['hora_descanso_e']; 
                            $salida = $get_detalle[$posicion]['hora_descanso_s']; 
                        }else{
                            $entrada = "13:00";
                            $salida = "14:00";
                        } 
                ...
                <div class="col-md-12 row conf_descanso_ma_u">
                    <?php 
                        $busq_detalle = in_array('2', array_column($get_detalle, 'dia'));
                        $posicion = array_search('2', array_column($get_detalle, 'dia'));
                        if ($busq_detalle != false){ 
                    ...
                    <div class="form-group col-md-2">
                        <label class="new-control new-checkbox checkbox-outline-primary">
                            <input type="checkbox" class="new-control-input" id="con_descanso_ma_u" name="con_descanso_ma_u" value="1" <?php echo $chk_martes; ?> onclick="Horario_Descanso_U('ma');">
                            <span class="new-control-indicator"></span>Martes
                        </label>
                    </div>
                ...
                <div class="col-md-12 row conf_descanso_mi_u">
                    <?php 
                        $busq_detalle = in_array('3', array_column($get_detalle, 'dia'));
                        $posicion = array_search('3', array_column($get_detalle, 'dia'));
                        if ($busq_detalle != false){ 
                    ...
                    <div class="form-group col-md-2">
                        <label class="new-control new-checkbox checkbox-outline-primary">
                            <input type="checkbox" class="new-control-input" id="con_descanso_mi_u" name="con_descanso_mi_u" value="1" <?php echo $chk_miercoles; ?> onclick="Horario_Descanso_U('mi');">
                ...
                <div class="col-md-12 row conf_descanso_ju_u">
                    <?php 
                        $busq_detalle = in_array('4', array_column($get_detalle, 'dia'));
                        $posicion = array_search('4', array_column($get_detalle, 'dia'));
                        if ($busq_detalle != false){ 
                    ...
                    <div class="form-group col-md-2">
                        <label class="new-control new-checkbox checkbox-outline-primary">
                            <input type="checkbox" class="new-control-input" id="con_descanso_ju_u" name="con_descanso_ju_u" value="1" <?php echo $chk_jueves; ?> onclick="Horario_Descanso_U('ju');">
                            <span class="new-control-indicator"></span>Jueves
                        </label>
                    </div>
                ...
                <div class="col-md-12 row conf_descanso_vi_u">
                    <?php 
                        $busq_detalle = in_array('5', array_column($get_detalle, 'dia'));
                        $posicion = array_search('5', array_column($get_detalle, 'dia'));
                        if ($busq_detalle != false){ 
                    ...
                    <div class="form-group col-md-2">
                        <label class="new-control new-checkbox checkbox-outline-primary">
                            <input type="checkbox" class="new-control-input" id="con_descanso_vi_u" name="con_descanso_vi_u" value="1" <?php echo $chk_viernes; ?> onclick="Horario_Descanso_U('vi');">
                            <span class="new-control-indicator"></span>Viernes
                        </label>
                    </div>
                ...
                <div class="col-md-12 row conf_descanso_sa_u">
                    <?php 
                        $busq_detalle = in_array('6', array_column($get_detalle, 'dia'));
                        $posicion = array_search('6', array_column($get_detalle, 'dia'));
                        if ($busq_detalle != false){ 
                    ...
                    <div class="form-group col-md-2">
                        <label class="new-control new-checkbox checkbox-outline-primary">
                            <input type="checkbox" class="new-control-input" id="con_descanso_sa_u" name="con_descanso_sa_u" value="1" <?php echo $chk_sabado; ?> onclick="Horario_Descanso_U('sa');">
                            <span class="new-control-indicator"></span>Sábado
                        </label>
                    </div>
                ...
                <div class="col-md-12 row conf_descanso_do_u">
                    <?php 
                        $busq_detalle = in_array('7', array_column($get_detalle, 'dia'));
                        $posicion = array_search('7', array_column($get_detalle, 'dia'));
                        if ($busq_detalle != false){ 
                    ...
                    <div class="form-group col-md-2">
                        <label class="new-control new-checkbox checkbox-outline-primary">
                            <input type="checkbox" class="new-control-input" id="con_descanso_do_u" name="con_descanso_do_u" value="1" <?php echo $chk_domingo; ?> onclick="Horario_Descanso_U('do');">
                            <span class="new-control-indicator"></span>Domingo
                        </label>
                    </div>
                </div>
