            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="toolbar d-flex mt-3">
                        <div align="left" class="col-md-12 row">
                            <div class="form-group col-md-1">
                                <label class="control-label text-bold">Estado: </label>
                            </div> 
                            <div class="form-group col-md-2">
                                <select name="estado_intencioni" id="estado_intencioni" class="form-control" onchange="Busca_Intencion_Renuncia()">
                            ...
                            <div class="form-group col-md-2">
                                <button type="button" class="btn btn-primary mb-2 mr-2" title="Registrar" data-toggle="modal" data-target="#ModalRegistro" app_reg_metalikas="<?= url('Corporacion/Modal_Intencion_Renuncia') ?>" >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-square"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                                    Registrar
                                </button>
                                <a class="btn mb-2 mr-2" style="background-color: #28a745 !important;" onclick="Excel_Intencion_Renuncia()">
                    ...
                    <div class="table-responsive mb-4 mt-4" id="div_busqueda">
...
<script>
    ...
    $('#estado_solicitud').on('change', function() {
        ...
        var url = "{{ url('Corporacion/Buscar_Estado_Solicitud_Papeletas_Salida_Usuario') }}";
            $.ajax({
                type:"POST",
                url:url,
