<form id="formulario_saludo"  method="POST" enctype="multipart/form-data" class="needs-validation">
    <div class="modal-header">
        <h5 class="modal-title">Lista de Saludos para <b><?php echo $get_id[0]['usuario_nombres']." ".$get_id[0]['usuario_apater']." ".$get_id[0]['usuario_amater'] ?></b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
        </button>
    </div> 
                
    <div class="modal-body" style="max-height:700px; overflow:auto;max-width:100%; overflow:auto;">
        <div class="col-md-12 row" id="list_saludos">     
            <table id="zero-config-detalle-cumple" class="table table-hover" style="width:100%; overflow:auto;">
                <thead>
                    <tr>
...
$(document).ready(function() {
        $('#zero-config-detalle-cumple').DataTable({
        "oLanguage": {
