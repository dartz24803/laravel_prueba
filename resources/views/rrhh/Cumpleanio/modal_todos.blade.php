                    ...
                    <tr>
                        ...
                        <td>
                            <div class="td-content">
                                <span><?= $list['nom_area']; ?></span>
                            </div>
                        </td>
                        <td>
                            <div class="td-content">
                                <span><?= $list['centro_labores']; ?></span>
                            </div>
                        </td>
                        <td>
                            <div class="td-content customer-name">
                            ...
                            <div class="td-content">
                                <?php if($list['id_historial']!=""){
                                    if($list['estado_registro']==1){?> 
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ url('Corporacion/Modal_Saludo_Cumpleanio/'. $list['id_usuario']. '/1/2"><span class="badge badge-success">Modificar Saludo</span></a>            
                                    <?php }else{?> 
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ url('Corporacion/Modal_Saludo_Cumpleanio/'. $list['id_usuario']. '/2/2"><span class="badge badge-primary">Enviado</span></a>            
                                    <?php }
                                }else{?> 
                                    <a href="javascript:void(0)" data-toggle="modal" data-target="#ModalUpdate" app_elim="{{ url('Corporacion/Modal_Saludo_Cumpleanio/'. $list['id_usuario']. '/1/2"><span class="badge badge-success">Saludar</span></a>        
                                <?php }?>
                            </div>
                        </td>
                    </tr>
