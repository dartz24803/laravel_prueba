<div class="col-md-12 row">
    ...
    <div class="form-group col-md-1">
        ...
        <div>
            <label class="new-control new-radio radio-primary">
                <input type="radio" class="new-control-input" id="r_diai" value="1" name="tipo_fechai" checked onclick="Div_Tipo_Fecha()">
    ...
    <div class="form-group col-md-2">
        <label for="">&nbsp;</label>
        <div>
            <button type="button" class="btn btn-primary mb-2 mr-2 " title="Buscar" onclick="Buscar_Asistencia_Colaborador()">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search toggle-search">
                    <circle cx="11" cy="11" r="8"></circle>
                    <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
                </svg>
            </button>
            <button type="button" class="btn mb-2 mr-2 " style="background-color: #28a745 !important;" onclick="Excel_Asistencia_Colaborador();" title="Excel">
    ...
    @csrf
    <div class="table-responsive mb-4 mt-0" id="lista_asistencia">
    </div>
