...
<script>
    $(document).ready(function() {
        ...
        $("#busqueda_papeleta_gestion").trigger("click");
    });
    ...
    function Aprobar_Solicitud(id) {
        ...
        var url = "<?php echo site_url(); ?>Corporacion/Aprobar_Solicitud";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        Swal(
                            ...
                            window.location = "<?php echo site_url(); ?>Corporacion/Lista_Papeletas_Salida_Gestion"; 
                        });
                    }
                });
            }
    ...
    function Anular_Solicitud(id) {
        ...
        var url = "<?php echo site_url(); ?>Corporacion/Anular_Solicitud";
