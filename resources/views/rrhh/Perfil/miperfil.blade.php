                ...
                <div class="user-profile layout-spacing">
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="text-center user-info">
                            <img src="<?php if($usuario[0]['foto_nombre'] !="") {echo $get_foto[0]['url_config'].$usuario[0]['foto_nombre']; } else{echo asset('template/assets/img/90x90.jpg'); } ?>" height="90px" width="90px" alt="avatar">
