<div class="row">
    ...
    <div class="col-md-6">
        <div class="form-group" id="medicamentou">
            ...
            <input <?php if(isset($list_usuario['0']['alergia']) && $list_usuario[0]['alergia'] == 2){ echo "disabled";} ?> type="text" class="form-control mb-4" id="nom_enfermedad" name="nom_enfermedad" value="<?php echo $get_id['0']['nom_alergia']; ?>">
