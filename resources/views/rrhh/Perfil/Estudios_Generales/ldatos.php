        ...
        <tr>
            ...
            <td>
                <?php if($list["documentoe"]!=""){
                    ...
                    <a style="cursor:pointer;display: -webkit-inline-box;" data-title="Documento de Estudio" data-toggle="modal" data-target="#Modal_IMG_Link" data-imagen="<?php echo $url_estudiog[0]['url_config'].$list["documentoe"]?>" >
