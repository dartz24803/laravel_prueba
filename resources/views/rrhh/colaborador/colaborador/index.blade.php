<div class="toolbar d-md-flex align-items-md-center mt-3">
    <div class="form-group col-lg-2">
        ...
        <select class="form-control" id="id_gerenciab" name="id_gerenciab" onchange="Lista_Colaborador();">
    ...
    <div class="col-lg-10">
        <a class="btn mb-2 mb-sm-0 mb-md-2 mb-lg-0" style="background-color: #28a745 !important;" href="#" {{--onclick="Excel_Colaborador();"--}}>
...
<script>
    ...
    function Lista_Colaborador(){
        ...
        var url = "{{ route('colaborador_co.list') }}";
