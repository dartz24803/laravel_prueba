<form id="formularioe" method="POST" enctype="multipart/form-data" class="needs-validation">
    ...
    <div class="modal-body" style="max-height:700px; overflow:auto;">
        <div class="row">
            ...
            <div class="form-group col-lg-4">
                <input type="text" class="form-control" id="num_doce" name="num_doce" 
                placeholder="Ingresar número documento" value="{{ $get_id->num_doc }}"
    ...
    <div class="modal-footer">
        @csrf
        @method('PUT')
        <button class="btn btn-primary" type="button" onclick="Update_Postulante();">Guardar</button>
...
<script>
    function Update_Postulante() {
        ...
        var url = "{{ route('postulante_reg.update', $get_id->id_postulante) }}";
