                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="fecha_revision3" value="<?php echo date("Y-m-d");?>"  name="fecha_revision3">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="control-label text-bold">Fecha Fin:</label>
                                                    <input type="date" class="form-control" id="fecha_revision_fin3" value="<?php echo date("Y-m-d");?>"  name="fecha_revision_fin3">
                                                </div>
                                            </div>
