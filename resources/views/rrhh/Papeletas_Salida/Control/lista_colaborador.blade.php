                                    ...
                                    <tr>
                                        ...
                                        <?php if( $list['estado_solicitud']==2) {  ?>   
                                                    ...
                                                    <?php if($list['horar_salida'] != '00:00:00' || $list['horar_salida'] === null){ ?>
                                                            <?php if( ($list['horar_retorno']=== '00:00:00' || $list['horar_salida'] === null) && $list['sin_retorno']!='1') {  ?>   
                                                            ...
                                                            <?php } ?>
                                                            <?php if( $list['sin_retorno']!='1' && ($list['horar_retorno']=== '00:00:00' || $list['horar_salida'] === null)){  ?>
