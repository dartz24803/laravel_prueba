                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area simple-tab">
                        <ul class="nav nav-tabs  mb-3 mt-3" id="simpletab" role="tablist">
                            <?php /*if($permiso_pps==1 || $id_nivel==1 || $id_puesto==23 || $id_puesto==36 || $id_puesto==24 || $id_puesto==26 || $id_puesto==128 || $usuario_codigo=="30858033" ||
                                $usuario_codigo=="48538866" || $usuario_codigo=="60603227" || $id_puesto==21 || $id_puesto==19){*/ ?>
                                <li class="nav-item">
                            ...
                            <?php //} ?>
                            <?php if($permiso_pps==1 || $id_nivel==1 || $usuario_codigo==="44582537" || $usuario_codigo==="46553611" || $usuario_codigo==="29426417" ||
                                    $usuario_codigo==="08584691" || $usuario_codigo==="46156858" || $id_puesto==19 || $id_puesto==21 || $id_puesto==23 || $id_puesto==40 || 
                            ...
                            <?php }?>
                            <?php if($id_nivel==1 || $id_puesto==23 || $id_puesto==36 || $id_puesto==24 || $id_puesto==26 || $id_puesto==128 || $usuario_codigo=="48538866" || 
                            $usuario_codigo=="60603227" || $id_puesto==21 || $id_puesto==19 || $id_puesto==279 || $id_puesto==209 || $id_puesto==307 ||
                            $id_puesto==315){?>
                                <li class="nav-item">
                        ...
                        <div class="tab-content" id="simpletabContent">
                                            ...
                                            <div class="widget-content widget-content-area br-6">
                                                <div class="toolbar">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-2">
                                                            <button type="button" class="btn btn-primary" title="Registrar" data-toggle="modal" data-target="#ModalRegistroSlide" app_reg_slide="<?= site_url('Corporacion/Modal_Papeletas_Salida/0') ?>" >
                                                                Registrar
                                                            </button>
                                                        </div>
                                                        ...
                                                        <?php if($registro_masivo == 1 || $id_nivel==1 || $id_puesto==314) {  ?>  
                                                            <div class="col-md-4 col-lg-3">
                                                                <button type="button" class="btn btn-primary" title="Registrar Masivo" data-toggle="modal" data-target="#ModalRegistroSlide" app_reg_slide="<?= site_url('Corporacion/Modal_Papeletas_Salida/1') ?>" >
                                                                    Registro Masivo
                                                                </button>
                                                            </div>
                                                        <?php } ?>
                            ...
                            <?php //} ?>
                            <?php if($permiso_pps==1 || $id_nivel==1 || $usuario_codigo==="44582537" || $usuario_codigo==="46553611" || $usuario_codigo==="29426417" ||
                                    $usuario_codigo==="08584691" || $usuario_codigo==="46156858" || $id_puesto==19 || $id_puesto==21 || $id_puesto==23 || $id_puesto==10 || $id_puesto==93 || $id_puesto==315){ ?>
                            ...
                            <?php } ?>
                            <?php if($id_nivel==1 || $id_puesto==23 || $id_puesto==36 || $id_puesto==24 || $id_puesto==26 || $id_puesto==128 || $usuario_codigo=="30858033" ||
                                $usuario_codigo=="48538866" || $usuario_codigo=="60603227" || $id_puesto==21 || $id_puesto==19 || $id_puesto==279 || $id_puesto==209 || $id_puesto==307 || $id_puesto==315){ ?>
