...
Route::controller(ColaboradorController::class)->group(function () {
    ...
    Route::delete('ColaboradorController/{id}/Delete_CursosC', 'Delete_CursosC')->name('colaborador_cc.delete');
...
Route::controller(MiEquipoController::class)->group(function () {
    ...
    Route::get('MiEquipo/Modal_Update_ListaMiequipo/{id}', 'Modal_Update_ListaMiequipo');
...
Route::controller(AsistenciaColaboradoresController::class)->group(function () {
    ...
    Route::get('AsistenciaColaborador/Excel_Asistencia_Semana_Colaborador/{base}/{area}/{usuario}/{tipo_fecha}/{dia}/{mes}', 'Excel_Asistencia_Semana_Colaborador')->name('asistencia_colaborador_semana.excel');
