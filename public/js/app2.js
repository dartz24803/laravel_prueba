var App = function() {
    ...
    var categoryScroll = {
        scrollCat: function() {
          var sidebarWrapper = document.querySelector('.sidebar-wrapper [aria-expanded="true"]');
          if (sidebarWrapper) {
            ...
            console.error('No element with aria-expanded="true" found.');
          }
        }
    };
...
$(document).ready(function() {
    $('#sidebarSearch').on('input', function() {
        ...
        // Filtra los elementos del sidebar
        $('.menu, .submenu li').each(function() {
            var itemText = $(this).text().toLowerCase();
            $(this).toggle(itemText.includes(searchText));
            $("#accordionExample").removeClass('ps ps--active-y');
        });
    });

    $('form.search-full').on('submit', function(e) {
        e.preventDefault();
    });
});
