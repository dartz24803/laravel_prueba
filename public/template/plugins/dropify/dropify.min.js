    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: { default: "Arrastre y suelte un archivo aquí o haga clic en", replace: "Arrastra y suelta o haz clic para reemplazar", remove: "Eliminar", error: "Vaya, se agregó algo incorrecto." },
                error: {
                    ...
                    fileExtension: "El archivo no esta permitido ({{ value }} only).",
                },
                tpl: {
