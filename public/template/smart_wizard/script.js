...
function _createClass(t, s, e) {
    return (
        s && _defineProperties(t.prototype, s),
...
!(function (e) {
    ...
    var i = {
            ...
            keyboard: { keyNavigation: !0, keyLeft: [37], keyRight: [39] },
        ...
        e = (function () {
            function n(t, s) {
                ...
                _classCallCheck(this, n),
                    (this.options = l.extend(!0, {}, i, s)),
                    (this.main = l(t)),
                    (this.nav = this._getFirstDescendant(
                        "." + this.options.style.navCss
                    )),
                    (this.container = this._getFirstDescendant(
                        "." + this.options.style.contentCss
                    )),
                    (this.steps = this.nav.find(
                        "." + this.options.style.navLinkCss
                    )),
                    (this.pages = this.container.children(
                        "." + this.options.style.contentPanelCss
                    )),
                    (this.progressbar = this.main.find(
                        "." + this.options.style.progressCss
                    )),
            ...
            return (
                _createClass(n, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.main
                                ...
                                (!0 ===
                                    this.options.anchor
                                        .enableNavigationAlways &&
                                    !0 ===
                                        this.options.anchor.enableNavigation) ||
                                    this.steps.addClass(
                                        this.options.style.anchorDefaultCss
                                    ),
                                l.each(
                                ...
                                l.each(
                                    ...
                                    function (t, s) {
                                        e.steps
                                            .eq(s)
                                            .addClass(
                                                e.options.style.anchorErrorCss
                                            );
                                    }
                                ),
                                l.each(
                                    this.options.warningSteps,
                                    function (t, s) {
                                        e.steps
                                            .eq(s)
                                            .addClass(
                                                e.options.style.anchorWarningCss
                                            );
                                    }
                                ),
                                l.each(
                                    ...
                                    function (t, s) {
                                        e.steps
                                            .eq(s)
                                            .addClass(
                                                e.options.style.anchorHiddenCss
                                            );
                                    }
                                );
                        },
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.steps.on("click", function (t) {
                                var s;
                                t.preventDefault(),
                                    !0 === e.options.anchor.enableNavigation &&
                                        ((s = l(t.currentTarget)),
                                        e._isShowable(s) &&
                                            e._showStep(e.steps.index(s)));
                            }),
                                this.main.on("click", function (t) {
                                    l(t.target).hasClass(
                                        e.options.style.btnNextCss
                                    )
                                        ? (t.preventDefault(),
                                          e._navigate("next"))
                                        : l(t.target).hasClass(
                                              e.options.style.btnPrevCss
                                          ) &&
                                          (t.preventDefault(),
                                          e._navigate("prev"));
                                }),
                                ...
                                l(window).on("hashchange", function (t) {
                                    var s;
                                    !0 !== e.options.backButtonSupport ||
                                        (!1 !== (s = e._getURLHashIndex()) &&
                                            e._isShowable(e.steps.eq(s)) &&
                                            (t.preventDefault(),
                                            e._showStep(s)));
                                }),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var s = l("<div></div>")
                                    ...
                                    .attr("role", "toolbar"),
                                e =
                                    !1 !== this.options.toolbar.showNextButton
                                        ? l("<button></button>")
                                ...
                                n =
                                    !1 !==
                                    this.options.toolbar.showPreviousButton
                                        ? l("<button></button>")
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            this._showStep(
                                this._getShowable(this.current_index, t)
                            );
                        },
                    },
                    {
                        ...
                        value: function (n) {
                            ...
                            this._loadContent(n, function () {
                                ...
                                i._transit(e, s, o, function () {
                                    i._fixHeight(n),
                                        i._triggerEvent("showStep", [
                                            t,
                                            n,
                                            o,
                                            i._getStepPosition(n),
                                        ]);
                                }),
                                    (i.current_index = n),
                                    i._setButtons(n),
                    ...
                    },
                    {
                        ...
                        value: function (e, n) {
                            ...
                            return (
                                ("prev" == n
                                    ? l(this.steps.slice(0, e).get().reverse())
                                    : this.steps.slice(e + 1)
                                ).each(function (t, s) {
                                    if (i._isEnabled(l(s)))
                                        return (
                                            (o =
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            return (
                                (!1 !==
                                    this.options.anchor
                                        .enableDoneStateNavigation ||
                                    !s) &&
                                !(
                                    !1 ===
                                        this.options.anchor
                                            .enableNavigationAlways && !s
                                )
                            );
                        },
                    },
                    {
                        ...
                        value: function (t) {
                            return (
                                ...
                                !t.hasClass(this.options.style.anchorHiddenCss)
                            );
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, s) {
                            var e, n, i, o;
                            l.isFunction(this.options.getContent) &&
                            (e = this._getStepPage(t))
                                ? ((n = this._getStepDirection(t)),
                                  (i = this._getStepPosition(t)),
                                  (o = this._getStepAnchor(t)),
                        ...
                        value: function (s, e, t, n) {
                            var i =
                                l.fn.smartWizard.transitions[
                                    this.options.transition.animation
                                ];
                            this._stopAnimations(),
                                l.isFunction(i)
                                    ? i(s, e, t, this, function (t) {
                                          !1 === t &&
                                              (null !== e && e.hide(),
                                              s.show()),
                                              n();
                    ...
                    },
                    {
                        key: "_stopAnimations",
                        value: function () {
                            l.isFunction(this.container.finish) &&
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var s;
                            !1 !== this.options.autoAdjustHeight &&
                                ((s = this._getStepPage(t).outerHeight()),
                                l.isFunction(this.container.finish) &&
                                l.isFunction(this.container.animate) &&
                                0 < s
                                    ? this.container
                                          .finish()
                                          .animate(
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            null !== this.current_index &&
                                ...
                                ((s = this.options.style.anchorActiveCss),
                                (e = ""),
                                !1 !== this.options.anchor.enableDoneState &&
                                    ((e += this.options.style.anchorDoneCss),
                                    !1 !==
                                        this.options.anchor
                                            .unDoneOnBackNavigation &&
                                        "backward" ===
                                            this._getStepDirection(t) &&
                                        (s +=
                                            " " +
                                            this.options.style.anchorDoneCss)),
                                this.steps
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            var s = this.nav.width(),
                                e =
                                    (((s / this.steps.length) * (t + 1)) / s) *
                                    100;
                            document.documentElement.style.setProperty(
                                "--sw-progress-width",
                                e + "%"
                            ),
                                0 < this.progressbar.length &&
                                    this.progressbar
                                        .find(
                                            "." +
                                                this.options.style
                        ...
                        value: function (t) {
                            if (this.options.keyboard.keyNavigation)
                                if (
                                    ...
                                    l.inArray(
                                        t.which,
                                        this.options.keyboard.keyLeft
                                    )
                                )
                                    this._navigate("prev"), t.preventDefault();
                                else {
                                    if (
                                        !(
                                            -1 <
                                            l.inArray(
                                                t.which,
                                                this.options.keyboard.keyRight
                                            )
                                        )
                                    )
                                        return;
                    ...
                    },
                    {
                        ...
                        value: function (t, s) {
                            var e = l.Event(t);
                            return (
                                this.main.trigger(e, s),
                                !e.isDefaultPrevented() && e.result
                            );
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (t, s, e) {
                            ...
                            var i = "";
                            "default" == s
                                ? (i = this.options.style.anchorDefaultCss)
                                : "active" == s
                                ? (i = this.options.style.anchorActiveCss)
                                : "done" == s
                                ? (i = this.options.style.anchorDoneCss)
                                : "disable" == s
                                ? (i = this.options.style.anchorDisabledCss)
                                : "hidden" == s
                                ? (i = this.options.style.anchorHiddenCss)
                                : "error" == s
                                ? (i = this.options.style.anchorErrorCss)
                                : "warning" == s &&
                                  (i = this.options.style.anchorWarningCss),
                    ...
                    },
                    {
                        ...
                        value: function (t, s) {
                            (!0 != (s = !1 !== s) &&
                                !this._isShowable(this.steps.eq(t))) ||
                                (!0 === s &&
                                    0 < t &&
                                    this.options.anchor.enableDoneState &&
                                    this.options.anchor
                                        .markPreviousStepsAsDone &&
                                    this.steps
                                        .slice(0, t)
                                        .addClass(
                                            this.options.style.anchorDoneCss
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return {
                                currentStep: this.current_index
                                    ? this.current_index
                                    : 0,
    ...
    (l.fn.smartWizard = function (t) {
        if (void 0 === t || "object" === _typeof(t))
            return this.each(function () {
                l.data(this, "smartWizard") ||
                    l.data(this, "smartWizard", new e(this, t));
            });
        if ("string" == typeof t && "_" !== t[0] && "init" !== t) {
            var s = l.data(this[0], "smartWizard");
            return (
                "destroy" === t && l.data(this, "smartWizard", null),
                s instanceof e && "function" == typeof s[t]
        ...
        (l.fn.smartWizard.transitions = {
            fade: function (t, s, e, n, i) {
                l.isFunction(t.fadeOut)
                    ? s
                        ? s.fadeOut(
                              n.options.transition.speed,
                              n.options.transition.easing,
                              function () {
                                  t.fadeIn(
                                      n.options.transition.speed,
                                      n.options.transition.easing,
            ...
            slideHorizontal: function (t, s, e, i, n) {
                var o, a, r, h;
                l.isFunction(t.animate)
                    ? ((o = function (t, s, e, n) {
                          t.css({ position: "absolute", left: s })
                              .show()
                              .animate(
                                  { left: e },
                      ...
                      (a = i.container.width()),
                      s &&
                          ((r = s.css(["position", "left"])),
                          o(s, 0, a * ("backward" == e ? 1 : -1), function () {
                              s.hide().css(r);
                          })),
                      (h = t.css(["position"])),
                      o(t, a * ("backward" == e ? -2 : 1), 0, function () {
                          t.css(h), n();
                      }))
                    : n(!1);
            },
            slideVertical: function (t, s, e, i, n) {
                ...
                l.isFunction(t.animate)
                    ? ((o = function (t, s, e, n) {
                      ...
                      -1 == i.current_index &&
                          i.container.height(t.outerHeight()),
                      (a = i.container.height()),
                      s &&
                          ((r = s.css(["position", "top"])),
                          o(s, 0, a * ("backward" == e ? -1 : 1), function () {
                              s.hide().css(r);
                          })),
                      (h = t.css(["position"])),
                      o(t, a * ("backward" == e ? 1 : -2), 0, function () {
                          t.css(h), n();
                      }))
                    : n(!1);
            },
            css: function (t, s, e, n, i) {
                var o, a, r;
                0 != n.options.transition.fwdHideCss.length &&
                0 != n.options.transition.bckHideCss.length
                    ? ((o = function (t, s, e) {
                          (s && 0 != s.length) || e(),
                              t.addClass(s).one("animationend", function (t) {
                                  l(t.currentTarget).removeClass(s), e();
                              }),
                              t
                                  .addClass(s)
                                  .one("animationcancel", function (t) {
                                      l(t.currentTarget).removeClass(s),
                                          e("cancel");
                                  });
                      }),
                      (a =
                          n.options.transition.prefixCss +
                          " " +
                          ("backward" == e
                              ? n.options.transition.bckShowCss
                              : n.options.transition.fwdShowCss)),
                      s
                          ? ((r =
                                n.options.transition.prefixCss +
                                " " +
                                ("backward" == e
                                    ? n.options.transition.bckHideCss
                                    : n.options.transition.fwdHideCss)),
                            o(s, r, function () {
                                s.hide(),
                                    o(t, a, function () {
                                        i();
