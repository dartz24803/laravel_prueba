...
class MercaderiaEnviarFotografia extends Controller
{
    ...
    {
        $anio = $request->input('anio'); // Cambia 'anio' por el nombre del input en tu formulario si es diferente
        $mes = $request->input('mes'); // Cambia 'mesi' por el nombre del input en tu formulario si es diferente
    ...
    public function edit_merc_foto($id)
    {
