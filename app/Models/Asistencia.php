...
class Asistencia extends Model
{
    ...
    public function buscar_reporte_control_asistencia($cod_mes,$cod_anio,$cod_base,$num_doc,$tipo,$finicio,$ffin){
        ...
        $sql=" SELECT
            ...
            /*(SELECT CONCAT(DATE_FORMAT(t.punch_time,'%H:%i:%s'),'--',t.id_asistencia_remota) FROM ($vista) t WHERE a.num_doc = t.num_doc and DATE_FORMAT(t.punch_time,'%Y-%m-%d')=DATE_FORMAT(a.punch_time,'%Y-%m-%d') ORDER BY t.punch_time ASC LIMIT 1)*/ '00:00:00' as ingreso,
            /*(SELECT CONCAT(DATE_FORMAT(t.punch_time,'%H:%i:%s'),'--',t.id_asistencia_remota) FROM ($vista) t WHERE a.num_doc = t.num_doc and DATE_FORMAT(t.punch_time,'%Y-%m-%d')=DATE_FORMAT(a.punch_time,'%Y-%m-%d') ORDER BY t.punch_time ASC LIMIT 1, 1)*/ '00:00:00' as idescanso,
            /*(SELECT CONCAT(DATE_FORMAT(t.punch_time,'%H:%i:%s'),'--',t.id_asistencia_remota) FROM ($vista) t WHERE a.num_doc = t.num_doc and DATE_FORMAT(t.punch_time,'%Y-%m-%d')=DATE_FORMAT(a.punch_time,'%Y-%m-%d') ORDER BY t.punch_time ASC LIMIT 2, 1)*/ '00:00:00' as fdescanso,

            /*CASE WHEN (SELECT COUNT(*) FROM ($vista) t WHERE a.num_doc = t.num_doc and DATE_FORMAT(t.punch_time,'%Y-%m-%d')=DATE_FORMAT(a.punch_time,'%Y-%m-%d'))>3 THEN (SELECT CONCAT(DATE_FORMAT(t.punch_time,'%H:%i:%s'),'--',t.id_asistencia_remota) FROM ($vista) t WHERE a.num_doc = t.num_doc and DATE_FORMAT(t.punch_time,'%Y-%m-%d')=DATE_FORMAT(a.punch_time,'%Y-%m-%d') ORDER BY t.punch_time DESC LIMIT 1) ELSE '' END*/ '18:00:00' AS salida,
            /*CASE WHEN (SELECT COUNT(*) FROM ($vista) t WHERE a.num_doc = t.num_doc and DATE_FORMAT(t.punch_time,'%Y-%m-%d')=DATE_FORMAT(a.punch_time,'%Y-%m-%d'))>1 THEN (SELECT CONCAT(DATE_FORMAT(t.punch_time,'%H:%i:%s'),'--',t.id_asistencia_remota) FROM ($vista) t WHERE a.num_doc = t.num_doc and DATE_FORMAT(t.punch_time,'%Y-%m-%d')=DATE_FORMAT(a.punch_time,'%Y-%m-%d') ORDER BY t.punch_time DESC LIMIT 1) ELSE '' END*/ '13:00:00' AS salidasabado
