...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->foreign('id_estado_civil','use_fk_id_eciv')->references('id_estado_civil')->on('estado_civil');
            $table->foreign('id_genero','use_fk_id_gen')->references('id_genero')->on('genero');
            $table->foreign('id_nacionalidad','use_fk_id_nac')->references('id_nacionalidad')->on('nacionalidad');
            $table->foreign('id_tipo_documento','use_fk_id_tdoc')->references('id_tipo_documento')->on('tipo_documento');
            $table->foreign('id_nivel','use_fk_id_niv')->references('id_nivel')->on('nivel');
            $table->foreign('id_puesto','use_fk_id_pue')->references('id_puesto')->on('puesto');
